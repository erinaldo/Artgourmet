...
namespace Artebit.Restaurante.Administracao.Compras
{
    public partial class Estoque : System.Web.UI.Page
    {
        ...
        private void VerificarPermissoes()
        {
            ...
            var compl = new List<string> { "AD", "Estoque", "0" };
        ...
        protected void GridAcao(object sender, DirectEventArgs e)
        {
            ...
            if (comando == "novo")
            {
                ...
                registro.Add("tipo", "I");
                registro.Add("nomeTipo", "Início de estoque");
        ...
        protected void CalculaValorItem(object sender, RemoteValidationEventArgs e)
        {
            ...
            else
            {
                ...
                if (prod.custoMedio != null)
                {
                    ...
                    string und = Convert.ToString(ComboBoxUnidade.Value);

                    string valorTotal = ((qtde * (
                                                             from t in Contexto.Atual.EUNIDADE
                                                             where t.codUnd == und  && t.codUndBase == prod.undControle
                                                             select t.fatorConversao).FirstOrDefault().Value)
        ...
        protected void btnOkOC_Click(object sender, DirectEventArgs e)
        {
            ...
            CheckboxSelectionModel sm = GridItensMovimentoOC.SelectionModel.Primary as CheckboxSelectionModel;
