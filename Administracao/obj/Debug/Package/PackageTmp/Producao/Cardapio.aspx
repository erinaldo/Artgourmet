    ...
    <script type="text/javascript">
        ...
        function alinhaEsquerda(dataview) {
            if (dataview.getSelectionCount() == 0) {
                ...
                //colocar as posicoes 
                if (recordNova != null) {
                    recordNova.data.posicao = recordOriginal.data.posicao;
                }
            ...
            <Items>
                <ext:FormPanel ID="FormPanel1" runat="server" Border="false" Layout="Form" AutoWidth="true" Padding="0" Margins="0">
                    <Items>
                        ...
                        <ext:TabPanel EnableTabScroll="true" ID="TabPanel1" runat="server" Height="390" DeferredRender="false" Padding="0" Margins="0">
                            <Items>
                                ...
                                <%--Painel de Itens--%>
                                <ext:Panel ID="PanelItens" runat="server" HideMode="Offsets" Height="300" Title="Itens">
                                    <Items>
                                        <ext:RowLayout ID="RowLayout1" runat="server">
                                            <Rows>
                                                <ext:LayoutRow RowHeight=".26">
                                                                    ...
                                                                    <Html>
                                                                        <tpl for=".">
								                                            <div class="thumb-wrap" id="{idItemCard}">
									                                            <div style="background-color:{cor}; width:114px; height:21px; color:white; padding-top:7px;">{descricao}</div>
								                                            </div>
							                                            </tpl>
                                                        ...
                                                        <TopBar>
                                                            <ext:Toolbar ID="Toolbar2" runat="server">
                                                                <Items>
                                                                    ...
                                                                    <ext:Button ID="Button2" runat="server" ToolTip="Editar" Icon="ApplicationEdit">
                                                                        <Listeners>
                                                                            <Click Handler="carregarForm(DataViewGrupo1)" />
                                                                        </Listeners>
                                                                    </ext:Button>
                                                                    <ext:Button ID="Button3" runat="server" ToolTip="Alterar Cor" Icon="Color">
                                                                        <Menu>
                                                        ...
                                                        <TopBar>
                                                            <ext:Toolbar ID="Toolbar9" runat="server">
                                                                <Items>
                                                                    ...
                                                                    <ext:Button ID="Button16" runat="server" ToolTip="Editar" Icon="ApplicationEdit">
                                                                        <Listeners>
                                                                            <Click Handler="carregarForm(DataViewGrupo2)" />
                                                                        </Listeners>
                                                                    </ext:Button>
                                                                    <ext:Button ID="Button18" runat="server" ToolTip="Alterar Cor" Icon="Color">
                                                                        <Menu>
                                                                                ...
                                                                                <ext:DataView ID="DataViewCat1" runat="server"
                                                                                    ...
                                                                                    <Template ID="Template3" runat="server">
                                                                                        <Html>
                                                                                            <tpl for=".">
								                                                                <div class="thumb-wrap" id="{idItemCard}">
									                                                                <div style="background-color:{cor}; width:112px; height:20px; color:white; padding-top:5px;">{descricao}</div>
								                                                                </div>
							                                                                </tpl>
                                                                                            <div class="x-clear"></div>
                                                                                        </Html>
                                                                            ...
                                                                            <TopBar>
                                                                                <ext:Toolbar ID="Toolbar7" runat="server">
                                                                                    <Items>
                                                                                        ...
                                                                                        <ext:Button ID="Button6" runat="server" ToolTip="Editar" Icon="ApplicationEdit">
                                                                                            <Listeners>
                                                                                                <Click Handler="carregarForm(DataViewCat1)" />
                                                                                            </Listeners>
                                                                                        </ext:Button>
                                                                                        <ext:Button ID="Button9" runat="server" ToolTip="Alterar Cor" Icon="Color">
                                                                                            <Menu>
                                                                            ...
                                                                            <TopBar>
                                                                                <ext:Toolbar ID="Toolbar8" runat="server">
                                                                                    <Items>
                                                                                        ...
                                                                                        <ext:Button ID="Button20" runat="server" ToolTip="Alterar Cor" Icon="Color">
                                                                                            <Menu>
                                                                                        ...
                                                                                        <ext:PagingToolbar ID="PagingToolbar6" runat="server" DisplayInfo="false" StoreID="storeCat2" Flat="true" HideBorders="true" HideLabels="true" PageSize="12" HideRefresh="true" />
                                                                                    </Items>
                                                                                </ext:Toolbar>
                                                                            </TopBar>
                                                                        </ext:Panel>
            ...
            <Items>
                <ext:FormPanel ID="FormPanel2" runat="server" Border="false" Layout="Form" AutoWidth="true">
                    <Items>
                        ...
                        <ext:ColorPalette ID="cpCorItem" FieldLabel="Cor" runat="server">
                            <Listeners>
