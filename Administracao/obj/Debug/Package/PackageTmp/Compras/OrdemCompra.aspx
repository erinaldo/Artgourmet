<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdemCompra.aspx.cs" Inherits="Artebit.Restaurante.Administracao.Compras.OrdemCompra" %>
...
<body>
 ...
 <%-- Store da grid principal --%>
    ...
    <%-- Store dos dados da OC que aparecem na janela --%>
    <ext:Store ID="StoreFormulario" runat="server" AutoLoad="false" RemotePaging="true" OnRefreshData="StoreFormulario_RefreshData">
        <Reader>
            <ext:JsonReader IDProperty="codigo">
                <Fields>
                    ...
                    <ext:RecordField Name="codStatus" Type="String" />
                    <ext:RecordField Name="status" Type="String" />
                    <ext:RecordField Name="dataEmissao" Type="String" />
                    <ext:RecordField Name="fornecedor" Type="String" />
                    <ext:RecordField Name="condpagto" Type="String" />
                    <ext:RecordField Name="percFrete" Type="String" />
                    <ext:RecordField Name="valorFrete" Type="String" />
                    <ext:RecordField Name="percDesconto" Type="String" />
        ...
        <Listeners>
               <DataChanged Handler="  var record = this.getAt(0) || {};
                                        ...
                                        {
                                            JanelaOC.setTitle('Ordem de Compra: '+ record.get('codigo'));
                                        }
                   
                                        StoreStatus.reload();   
                                        StoreItemMovOC.reload();
                                        StoreProduto.reload();
                                        StoreTipo.reload();
        ...
        <%-- Store dos itens da OC --%>
    <ext:Store ID="StoreItensOC" runat="server" AutoLoad="false" RemotePaging="true" OnRefreshData="StoreItensOC_RefreshData">
        <Reader>
            <ext:JsonReader IDProperty="codigo">
                <Fields>
        ...
        <Listeners>
               ...
               <Add Handler="PagingToolbar2.changePage(StoreItensOC.getTotalCount());" />
    ...
    <ext:GridPanel ID="GridPrincipal" runat="server" Height="529" AutoWidth="true" StoreID="StorePrincipal"
        ...
        <TopBar>
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <%--Ordem de compra--%>
                    <ext:Button ID="Button2" runat="server" Text="NF" Icon="TransmitAdd">
                        <DirectEvents>
                            <Click OnEvent="GridAcao">
                                <ExtraParams>
                                    <ext:Parameter Name="codigo" Value="GridPrincipal.getSelectionModel().getSelected().data['codigo']"
                                        Mode="Raw" />
                                    <ext:Parameter Name="command" Value="NF" Mode="Value" />
                                </ExtraParams>
                            </Click>
                        </DirectEvents>
                    </ext:Button>
        ...
        <Listeners>
            <Command Handler="if(command == 'editar') {JanelaOC.show();}" />
                                            ...
                                            <ext:PortalColumn ID="PortalColumn2" runat="server" ColumnWidth="1" DefaultAnchor="100%"
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Portlet ID="Portlet5" runat="server" Padding="0" Title="Itens de Movimento" Icon="ServerStart">
                                                        <Items>
                                                            <ext:Label ID="Label1" runat="server" Text="Clique duas vezes em cima do item para editar." StyleSpec="font-size:12; color:red;"></ext:Label>   
                                                        ...
                                                        <Items>
                                                                ...
                                                                <Items>
                                                                    <ext:Panel ID="Panel27" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtValorTotal" Disabled="True" DataIndex="valorTotal" FieldLabel="Valor Total" Width="120" runat="server" LabelAlign="Top"/>
                                                                        </Items>
                                                                    </ext:Panel>
                                                             
                                                                    <ext:Panel ID="Panel28" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtPerFrete" FieldLabel="% Frete" Width="120" DataIndex="percFrete" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                    ...
                                                                    <ext:Panel ID="Panel29" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                            <Items>
                                                                                <ext:NumberField ID="txtValorFrete"  FieldLabel="Valor Frete" DataIndex="valorFrete" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                    ...
                                                                    <ext:Panel ID="Panel32" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtPerDesconto"  FieldLabel="% Desconto" DataIndex="percDesconto" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                    ...
                                                                    <ext:Panel ID="Panel30" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtValorDesconto"  FieldLabel="Valor Desconto" DataIndex="valorDesconto" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                    ...
                                    <ext:Portal ID="Portal4" runat="server" Layout="column" Height="360" Border="false">
                                        <Items>
                                            <ext:Portlet ID="Portlet8" runat="server" Padding="5" Title="Observações" Icon="ServerStart">
                                                <Items>
                                                    <ext:TextArea ID="txtObservacaoOC" FieldLabel="Observação" Width="750" Height="130" DataIndex="observacao" LabelAlign="Top" runat="server"/>
                                                </Items>
                                            </ext:Portlet>
                                        </Items>
                                    </ext:Portal>
            ...
            <ext:Button ID="Button8" runat="server" Text="OK" Icon="Accept">
                <DirectEvents>
                    <Click OnEvent="btnOkOC_Click">
                        ...
                        <ExtraParams>
                              <ext:Parameter Name="Itens" Value="Ext.encode(#{StoreItemMovOC}.getRecordsValues())" Mode="Raw" />
             ...
             <ext:Button ID="Button1" runat="server" Text="Salvar" Icon="Disk">
                <DirectEvents>
                    <Click OnEvent="btnSalvarOC_Click">
                        <EventMask ShowMask="true" Msg="Verificando..." MinDelay="500" />
                        <ExtraParams>
                              <ext:Parameter Name="Itens" Value="Ext.encode(#{StoreItemMovOC}.getRecordsValues())" Mode="Raw" />
        ...
        <TopBar>
            <ext:Toolbar ID="Toolbar3" runat="server" Flat="true">
                <Items>
                    ...
                    <ext:PagingToolbar ID="PagingToolbar2" runat="server" PageSize="1" Flat="true" StoreID="StoreItensOC"
                        DisplayInfo="false">
                    </ext:PagingToolbar>
