<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotaFiscal.aspx.cs" Inherits="Artebit.Restaurante.Administracao.Compras.NotaFiscal" %>
...
<body>
                ...
                <Items>
                    <ext:TabPanel EnableTabScroll="true" ID="TabPanelForm" runat="server" Height="470" DeferredRender="false"  >
                        <Items>
                            ...
                            <%-- Aba de Valores --%>
                            <ext:Panel ID="Panel400" HideMode="Offsets" runat="server" Title="Valores" Cls="AddProduto">
                                <Items>
                                    <ext:Portal ID="Portal40" runat="server" Layout="column" Height="360" Border="false">
                                        <Items>
                                        
                                            <ext:PortalColumn ID="PortalColumn7" runat="server" ColumnWidth="1" DefaultAnchor="100%"
                                                Layout="anchor" StyleSpec="padding:10px">
                                                <Items>
                                                    
                                                    <%--Identificação--%>
                                                    <ext:Portlet ID="Portlet7" runat="server" Padding="5" Title="Valores" Icon="DateGo">
                                                        <Items>
                                                                <ext:Container ID="Container7" runat="server" Layout="Column" Height="50">
                                                                <Items>
                                                             
                                                                    <ext:Panel ID="Panel33" runat="server" Width="500" Border="false" ColumnWidth=".5" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:ComboBox 
                                                                                ID="ComboBoxFornecedorNF" 
                                                                                runat="server" 
                                                                    ...
                                                                    <ext:Panel ID="Panel34" runat="server" Width="500" Border="false" ColumnWidth=".5" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:ComboBox 
                                                                                ID="ComboBoxCondPgtoNF" 
                                                                                runat="server" 
                                                                ...
                                                                <ext:Container ID="Container9" runat="server" Layout="Column" Height="50">
                                                                <Items>
                                                                    <ext:Panel ID="Panel35" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtValorTotalNF" Disabled="True"  FieldLabel="Valor Total" Width="120" runat="server" LabelAlign="Top"/>
                                                                        </Items>
                                                                    </ext:Panel>
                                                             
                                                                    <ext:Panel ID="Panel36" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtPerFreteNF" FieldLabel="% Frete" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                                <RemoteValidation  OnValidation="perFrete" />
                                                                            </ext:NumberField>
                                                                        </Items>
                                                                    </ext:Panel>
                                                            
                                                                    <ext:Panel ID="Panel37" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                            <Items>
                                                                                <ext:NumberField ID="txtValorFreteNF"  FieldLabel="Valor Frete" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                                <RemoteValidation  OnValidation="ValorFrete" />
                                                                            </ext:NumberField>
                                                                            </Items>
                                                                    </ext:Panel>
                                                                    
                                                                    <ext:Panel ID="Panel38" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtPerDescontoNF"  FieldLabel="% Desconto" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
                                                                                <RemoteValidation  OnValidation="perDesconto" />
                                                                            </ext:NumberField>
                                                                        </Items>
                                                                    </ext:Panel>
                                                                    
                                                                    <ext:Panel ID="Panel39" runat="server" Width="500" Border="false" ColumnWidth=".2" Header="false" Layout="Form" LabelAlign="Top">
                                                                        <Items>
                                                                            <ext:NumberField ID="txtValorDescontoNF"  FieldLabel="Valor Desconto" Width="120" runat="server" LabelAlign="Top" IsRemoteValidation="True">
    ...
    <ext:Window 
        ...
        Padding="7">
        <Items>
        <ext:FormPanel ID="FormItensNF" runat="server" Padding="7">
        <Items>
            <ext:TextField ID="txtSequenciaNF" DataIndex="seq" FieldLabel="Sequência" Width="250" Disabled="True" runat="server"/>
            
            <ext:ComboBox 
                ID="ComboBoxProdutoNF" 
                runat="server" 
                Width="350" 
                DataIndex="idProduto"
                FieldLabel="Produto" 
            ...
            <ext:TextArea ID="txtObservacaoItemNF" DataIndex="observacao" FieldLabel="Observação" Width="350    " Height="50" runat="server"/>
                
            <ext:ComboBox 
                ID="ComboBoxUnidadeNF" 
                runat="server" 
                Width="350" 
                FieldLabel="Unidade" 
            ...
            <ext:Container ID="Container3" runat="server" Layout="Column" Width="450" Height="65">
                <Items>
                    <ext:Hidden runat="server" ID="hdCodigoNF" DataIndex="codigo"></ext:Hidden>
                    

                    <ext:Panel ID="Panel3" runat="server" ColumnWidth="0.4" Border="false">
                        <Items>
                                <ext:NumberField ID="txtQTDENF" FieldLabel="Quantidade" DataIndex="quantidade" Width="70" LabelAlign="Top" IsRemoteValidation="True" runat="server">
                     ...
                     <ext:Panel ID="Panel8" runat="server" ColumnWidth="0.3" Border="false">
                        <Items>
                            <ext:TextField ID="txtCustoUnitarioNF" 
                    ...
                    <ext:Panel ID="Panel9" runat="server" ColumnWidth="0.3" Border="false">
                        <Items>
                            <ext:TextField ID="txtCustoTotalNF" Disabled="True" FieldLabel="Custo Total" Width="100" runat="server" DataIndex="valorTotal" LabelAlign="Top"/>
                        </Items>
                    </ext:Panel>
            ...
            <ext:Container ID="Container10" runat="server" Layout="Column" Width="450" Height="65">
                <Items>
                    <ext:Panel ID="Panel40" runat="server" ColumnWidth="0.4" Border="false">
                        <Items>
                                <ext:NumberField ID="txtQtdRecebeNF" FieldLabel="Quantidade a Receber" DataIndex="quantidadeReceber" Width="130" 
                     ...
                     <ext:Panel ID="Panel41" runat="server" ColumnWidth="0.3" Border="false">
                        <Items>
                            <ext:NumberField ID="txtVlrDescontoNF" DataIndex="valorDesconto" Disabled="false" FieldLabel="Valor Desconto" Width="100" 
                    ...
                    <ext:Panel ID="Panel42" runat="server" ColumnWidth="0.3" Border="false">
                        <Items>
                            <ext:DateField 
                                ID="txtDataEntregaNF" 
                                runat="server"
                            ...
                            <%--<ext:TextField ID="txtDataEntregaNF" FieldLabel="Data Entrega" Width="100" runat="server" DataIndex="dataEntrega" LabelAlign="Top"/>--%>
                        </Items>
                    </ext:Panel>
...
<%--        <TopBar>
            <ext:Toolbar ID="Toolbar2" runat="server" Flat="true">
                <Items>
                    ...
                    <ext:PagingToolbar ID="PagingToolbar3" runat="server" PageSize="1" Flat="true" StoreID="StoreFormulario"
                        DisplayInfo="false">
                    </ext:PagingToolbar>
