<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movimentacao.aspx.cs" Inherits="Artebit.Restaurante.Administracao.Compras.Movimentacao" %>
...
<body>
    ...
    <ext:Store ID="StoreFormulario" runat="server" AutoLoad="false" RemotePaging="true" OnRefreshData="StoreFormulario_RefreshData">
        ...
        <Listeners>
               <DataChanged Handler="  var record = this.getAt(0) || {};
                                        ...
                                        {
                                            JanelaPrincipal.setTitle('Movimentação: '+ record.get('codigo'));
                                        }
    ...
    <ext:Store ID="StoreLocal" runat="server"  AutoLoad="false" OnRefreshData="StoreLocal_RefreshData">
        <Reader>
            <ext:JsonReader IDProperty="codigo">
                <Fields>
                    <ext:RecordField Name="codigo" Type="Int" />
    ...
    <ext:GridPanel ID="GridPrincipal" runat="server" Height="529" AutoWidth="true" StoreID="StorePrincipal"
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
            <Columns>
                ...
                <ext:Column Header="Tipo" DataIndex="tipo" runat="server" Width="100" />
                <ext:Column Header="Status" DataIndex="status" runat="server" Width="100" />
                <ext:Column Header="Data de Emissão" DataIndex="dataEmissao" runat="server" Width="100" />
                                                            ...
                                                            AutoExpandColumn="produto">
                                                                <ColumnModel>
                                                                    <Columns>
                                                                        ...
                                                                        <ext:Column Header="Produto" DataIndex="produto"/>
                                                                        <ext:Column Header="Qtd" DataIndex="quantidade" Width="70px"/>
                                                                        <ext:Column Header="Preço Und" DataIndex="precoUnitario" Width="60px"/>
                                                                        <ext:Column Header="QTDE à Receber" DataIndex="quantidadeReceber" />
                                                                        <ext:Column Header="Data de Entrega" DataIndex="dataEntrega" />
    ...
    <ext:Window 
        ...
        <Items>
            ...
            <ext:TextArea ID="txtObservacao" FieldLabel="Observação" Width="450" Height="50" runat="server"/>
            ...
            <ext:Container ID="Container3" runat="server" Layout="Column" Width="350" Height="65">
                <Items>
                    <ext:Panel runat="server" ColumnWidth="0.6" Border="false">
                        <Items>
                                <ext:NumberField ID="txtQTDE" FieldLabel="Quantidade" Width="150" LabelAlign="Top" IsRemoteValidation="True" runat="server">
