...
{
    public class FuncionalidadeControl : ControladorBase
    {
        private readonly FuncionalidadeDAL dal = new FuncionalidadeDAL();
        ...
        /// <returns></returns>
        [Obsolete]
        public object ExecutaFuncao(GFUNCIONALIDADE obj, Funcoes funcao, List<string> compl)
        {
            try
            {
